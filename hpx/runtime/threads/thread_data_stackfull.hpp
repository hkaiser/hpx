...
#ifndef HPX_RUNTIME_THREADS_THREAD_DATA_STACKFULL_HPP
#define HPX_RUNTIME_THREADS_THREAD_DATA_STACKFULL_HPP
...
namespace hpx { namespace threads {
    ...
    class thread_data_stackfull : public thread_data
    {
    private:
        ...
        HPX_EXPORT static util::internal_allocator<thread_data_stackfull>
            thread_alloc_;
    ...
    public:
        ...
        thread_data_stackfull(thread_init_data& init_data, void* queue,
        ...
        HPX_EXPORT ~thread_data_stackfull();
