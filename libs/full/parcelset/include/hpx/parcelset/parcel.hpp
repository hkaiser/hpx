...
namespace hpx::parcelset::detail {
    ...
    public:
        ...
        naming::gid_type generate_unique_id(std::uint32_t locality_id) override;
    ...
    private:
        ...
        {
            hpx::serialization::detail::register_class_name<parcel>::instance
                .instantiate();
            return "parcel";
        }
        virtual std::string hpx_serialization_get_name() const
        {
            return parcel::hpx_serialization_get_name_impl();
        }
