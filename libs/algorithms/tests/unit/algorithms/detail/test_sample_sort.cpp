...
void test5()
{
    ...
    sample_sort(
        K.begin(), K.end(), comp, hpx::threads::hardware_concurrency(), Rbuf);
...
void test7()
{
    ...
    sample_sort(A.begin() + 1000, A.begin() + (1000 + NELEM));
    ...
    sample_sort(A.begin(), A.end(), std::less<std::uint64_t>(),
