...
namespace hpx::iostreams {
    ...
    using file_handle = void*;    // A.k.a. HANDLE
#else
    ...
    class HPX_CORE_EXPORT file_descriptor
    {
    public:
    ...
    class HPX_CORE_EXPORT file_descriptor_source : private file_descriptor
    {
    public:
        using handle_type = file_handle;
        using char_type = char;
    ...
    private:
        ...
        void open(std::filesystem::path const& path, std::ios_base::openmode);
    };

    class HPX_CORE_EXPORT file_descriptor_sink : private file_descriptor
    {
    public:
        using handle_type = file_handle;
        using char_type = char;
