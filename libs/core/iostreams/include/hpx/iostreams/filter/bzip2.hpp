...
namespace hpx::iostreams {
    ...
    namespace bzip2 {
        ...
        // Status codes
        HPX_CORE_EXPORT extern int const ok;
        HPX_CORE_EXPORT extern int const run_ok;
        HPX_CORE_EXPORT extern int const flush_ok;
        HPX_CORE_EXPORT extern int const finish_ok;
        HPX_CORE_EXPORT extern int const stream_end;
        HPX_CORE_EXPORT extern int const sequence_error;
        HPX_CORE_EXPORT extern int const param_error;
        HPX_CORE_EXPORT extern int const mem_error;
        HPX_CORE_EXPORT extern int const data_error;
        HPX_CORE_EXPORT extern int const data_error_magic;
        HPX_CORE_EXPORT extern int const io_error;
        HPX_CORE_EXPORT extern int const unexpected_eof;
        HPX_CORE_EXPORT extern int const outbuff_full;
        HPX_CORE_EXPORT extern int const config_error;

        // Action codes
        HPX_CORE_EXPORT extern int const finish;
        HPX_CORE_EXPORT extern int const run;

        // Default values
        inline constexpr int default_block_size = 9;
        inline constexpr int default_work_factor = 30;
        inline constexpr bool default_small = false;
    }    // End namespace bzip2.
    ...
    struct bzip2_params
    {
        ...
        explicit bzip2_params(bool small_)
          : small_(small_)
          , work_factor(0)
        {
        }
    ...
    //
    class HPX_CORE_EXPORT bzip2_error : public std::ios::failure
    {
    public:
    ...
    namespace detail {
        ...
        class HPX_CORE_EXPORT bzip2_base
        {
        public:
