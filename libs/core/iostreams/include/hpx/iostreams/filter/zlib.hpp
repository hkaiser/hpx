...
#include <hpx/iostreams/filter/symmetric.hpp>
...
namespace hpx::iostreams {
    ...
    namespace zlib {
        ...
        using xalloc_func = void* (*) (void*, zlib::uint, zlib::uint);
        using xfree_func = void (*)(void*, void*);

        // Compression levels
        HPX_CORE_EXPORT extern int const no_compression;
        HPX_CORE_EXPORT extern int const best_speed;
        HPX_CORE_EXPORT extern int const best_compression;
        HPX_CORE_EXPORT extern int const default_compression;

        // Compression methods
        HPX_CORE_EXPORT extern int const deflated;

        // Compression strategies
        HPX_CORE_EXPORT extern int const default_strategy;
        HPX_CORE_EXPORT extern int const filtered;
        HPX_CORE_EXPORT extern int const huffman_only;

        // Status codes
        HPX_CORE_EXPORT extern int const okay;
        HPX_CORE_EXPORT extern int const stream_end;
        HPX_CORE_EXPORT extern int const stream_error;
        HPX_CORE_EXPORT extern int const version_error;
        HPX_CORE_EXPORT extern int const data_error;
        HPX_CORE_EXPORT extern int const mem_error;
        HPX_CORE_EXPORT extern int const buf_error;

        // Flush codes
        HPX_CORE_EXPORT extern int const finish;
        HPX_CORE_EXPORT extern int const no_flush;
        HPX_CORE_EXPORT extern int const sync_flush;
        ...
        constexpr int default_window_bits = 15;
        constexpr int default_mem_level = 8;
        constexpr bool default_crc = false;
        constexpr bool default_noheader = false;
    }    // End namespace zlib.
    ...
    //
    class HPX_CORE_EXPORT zlib_error : public std::ios_base::failure
    {
    public:
    ...
    namespace detail {
        ...
        private:
            ...
            typedef
                typename std::allocator_traits<base_type>::size_type size_type;
        ...
        class HPX_CORE_EXPORT zlib_base
        {
        public:
