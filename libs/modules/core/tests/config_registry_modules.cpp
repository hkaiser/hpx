...
{
    {
        ...
        // We the configuration of all core modules and this module, added
        // through a generated file, so we expect eight configs.
        TEST(configs.size() == 8);
        ...
        auto const c = std::find_if(std::begin(configs), std::end(configs),
