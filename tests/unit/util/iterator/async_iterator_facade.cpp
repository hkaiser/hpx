...
#include <hpx/util/async_iterator_facade.hpp>
#include <hpx/util/lightweight_test.hpp>

#include "async_iterator_tests.hpp"
...
class counter_iterator
  : public hpx::util::async_iterator_facade<
...
int main()
{
    {
        int state = 0;
        tests::async_readable_iterator_test(
            counter_iterator<hpx::future<int> >(&state), 0);
