...
namespace tests
{
    ...
    template <typename Iterator, typename T>
    void async_readable_iterator_traversal_test(Iterator i1, T v, std::true_type)
    {
        auto && it = (i1++).get();
        auto && val = *it;
        T v2(val.get());
    ...
    template <typename Iterator, typename T>
    void async_readable_iterator_traversal_test(const Iterator i1, T v,
        std::false_type)
    {
    }

    template <typename Iterator, typename T>
    void async_readable_iterator_test(const Iterator i1, T v)
    {
        ...
        async_readable_iterator_traversal_test(
            i1, v,
